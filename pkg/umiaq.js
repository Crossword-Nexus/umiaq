 ...
 * @param {string} input_pattern
 * @param {string} error_message
 * @param {number} entry_list_size
 * @param {number} num_results_requested
 * @returns {string}
 */
export function get_debug_info(input_pattern, error_message, entry_list_size, num_results_requested) {
    let deferred3_0;
    let deferred3_1;
    try {
        const ptr0 = passStringToWasm0(input_pattern, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len0 = WASM_VECTOR_LEN;
        const ptr1 = passStringToWasm0(error_message, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
        const len1 = WASM_VECTOR_LEN;
        const ret = wasm.get_debug_info(ptr0, len0, ptr1, len1, entry_list_size, num_results_requested);
        deferred3_0 = ret[0];
        deferred3_1 = ret[1];
 ...
 */
export function initialize(debug_enabled) {
    wasm.initialize(debug_enabled);
}
 ...
 * @returns {any}
 */
export function parse_entry_list(text, min_score) {
    const ptr0 = passStringToWasm0(text, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.parse_entry_list(ptr0, len0, min_score);
    if (ret[2]) {
 ...
 * @param {string} input
 * @param {any} entry_list
 * @param {number} num_results_requested
 * @returns {any}
 */
export function solve_equation_wasm(input, entry_list, num_results_requested) {
    const ptr0 = passStringToWasm0(input, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.solve_equation_wasm(ptr0, len0, entry_list, num_results_requested);
    if (ret[2]) {
        throw takeFromExternrefTable0(ret[1]);
    }
    return takeFromExternrefTable0(ret[0]);
